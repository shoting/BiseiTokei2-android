...
public class YABiseiTokei extends Activity {
    ...
    public static final String BISEI_APP_DIR = "/sdcard/bisei-tokei/Payload/BiseiTokei2.app/";
    ...
    private void playVoice(String time) {
        ...
        boolean serifTime = (Integer.parseInt(time.substring(2, 4)) % 10 == 0) ? true : false;
